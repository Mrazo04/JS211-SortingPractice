  ...
  // With the same numbers, find the sum of the even values
    const sumEvens = (evens) => {
        ...
        let sum  = evens.reduce((total, num) => total + num);
        console.log(sum);
        return sum;
    ...
    const returnIndx = () => {
        ...
        let atxIdx = numbers.findIndex(function (num , i) {
            return num + i == 512
        });

     console.log(`index: ${atxIdx}, value: ${numbers[atxIdx]}`);
...
//   //using a higher order function, create an array of the unique 'weather_state_name' values of the weather array. Your function should return the following array ['Light Cloud', 'Heavy Cloud', 'Showers']
    const weatherStates = weather.map(function (object){
    return object.weather_state_name
    })
    console.log(weatherStates)

//   //find the id of the object in weather that has a min_temp of 15.915

const idealTemp = weather.filter((object) => object.min_temp === 15.915).map((item) => {
    return `${item.id}`;
  });
